...
//     BTAppContextSwitcher.setReturnURLScheme("com.oeki.buysell.braintree")
...
//     if url.scheme?.localizedCaseInsensitiveCompare("com.oeki.buysell.braintree") == .orderedSame {
